 ...
 ***************************************************************************************************
 * 实验现象
 * 1 本实验开机的时候先初始化SD卡，如果SD卡初始化完成，则提示LCD初始化成功。按下KEY0，
     读取SD卡扇区0的数据，然后通过串口发送到电脑。如果没初始化通过，则在LCD上提示初始化失败。
 * 2 LED0闪烁 ,提示程序运行。
 ...
 * 7 如果插了OV5640摄像头模块,且程序报SD卡错误,请拔了OV5640摄像头模块,然后按复位再测试
