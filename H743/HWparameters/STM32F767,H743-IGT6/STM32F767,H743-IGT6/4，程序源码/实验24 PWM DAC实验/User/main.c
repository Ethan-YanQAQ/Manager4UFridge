...
extern TIM_HandleTypeDef g_tim9_handle;
...
int main(void)
{
    ...
    while (1)
    {
        ...
        {
            adcx = __HAL_TIM_GET_COMPARE(&g_tim9_handle, PWMDAC_TIMX_CHY);     /* PWM DAC 定时器输出比较值 */
